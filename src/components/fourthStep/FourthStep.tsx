    ...
    <div className={styles.fourthStepWrapper}>
      ...
      {sum > 1500000 && (
        <div>
          ...
          понадобится распорядительный документ, в котором должны быть указаны
          программа мероприятия, список участников мероприятия и совокупная
          смета расходов.
        </div>
      )}
      {sum < 1500000 && (
        <div>
          ...
          понадобится служебная записка, в которой должны быть указаны программа
